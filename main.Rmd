...
# voglio mantenere tutti i token che hanno una corrispondenza nel vocabolario inglese
# trim sul file per eliminare gli spazi
...
# il sentiment negativo risulta essere inferiore a quello positivo fino alla fine degli anni '70
# avviene poi un inversione del trend: a partire dal nuovo millennio, il sentiment negativo risulta essere prevalente su quello positivo
# interessante notare come nelle decadi 70-80-90 i due sentiment siano bilanciati.
```
...
# il grafico ricorda una distribuzione classica della legge di Zipf
# poche parole vengono ripetute molte volte per tutte e 7 le decadi e molte parole vengono ripetute poche volte
# lo scostamento nella parte bassa, rispetto alla curva teorica, è dovuto probabilmente alla rimozione delle stop words
```
...
# La decade 1980-1990 è contraddistinta da parole francesi:
# da uno studio sul web ho imparato che in quella decade spopola il pop francese
```
